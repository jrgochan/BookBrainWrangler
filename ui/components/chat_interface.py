...
def render_chat_interface(on_submit: Optional[Callable[[str], str]] = None) -> Optional[str]:
    """
...
def render_context_display(context: str, show_context: bool = True) -> None:
    """
...
def simulate_typing(placeholder: st.empty, text: str, speed: float = 0.01) -> None:
    """
